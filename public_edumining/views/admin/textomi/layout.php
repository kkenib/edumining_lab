...
<div class="wrapper">
    ...
    <nav class="nav-default">
        ...
        -->
        <h1 class="nav-header"><a href="<?php echo admin_url(); ?>">Edumining Admin</a></h1>
        <ul class="nav">
            <?php
    ...
    <div class="content_wrapper">
        ...
        <div class="row header">
            ...
            <ul class="nav-top">
                ...
                <li><a href="<?php echo site_url('login/logout'); ?>"><i class="fa fa-sign-out"></i> 로그아웃</a></li>
            </ul>
        </div>
        <!-- end header -->
        <div class="contents">
...
<!-- end wrapper -->
<footer class="footer">
    <a href="<?php echo config_item('ciboard_website'); ?>" target="_blank">CIBoard</a>,
