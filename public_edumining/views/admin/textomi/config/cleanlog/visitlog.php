<div class="box">
    <div class="box-header">
        <ul class="nav nav-tabs">
            ...
            <li role="presentation" class="active"><a href="<?php echo admin_url($this->pagedir . '/visitlog'); ?>">방문자로그삭제</a></li>
                ...
                <tbody>
                    <tr>
                        <td>
                            ...
                            ?>
                                <input type="number" class="form-control" name="day" value="<?php echo set_value('day', 180); ?>" /> 일 이상된 방문자 로그를 모두 검색합니다.
