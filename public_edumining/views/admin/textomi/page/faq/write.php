        ...
        ?>
            ...
            <div class="form-horizontal">
                ...
                <div class="btn-group pull-right" role="group" aria-label="...">
                    ...
                    <button type="submit" class="btn btn-success btn-sm" id="submit">저장하기</button>
                </div>
            </div>
        <?php echo form_close(); ?>
    </div>
...
$(function() {
	...
	$("#submit").click(function() {
		oEditors.getById["faq_title"].exec("UPDATE_CONTENTS_FIELD", []);
		oEditors.getById["faq_content"].exec("UPDATE_CONTENTS_FIELD", []);
		oEditors.getById["faq_mobile_content"].exec("UPDATE_CONTENTS_FIELD", []);
	});
//]]>
</script>
