...
<div class="pop_body">
    ...
    <section class="mb30">
        <div class="grey_contbox brd_detail">
            <h3 id="title" class="mb10">리포트 제목</h3>
            <p id="class_info" class="mb10">1학년 2반 1학기 / abc_01</p>
            <p><time id="create_date" datetime="2021-12-14">2021.12.14</time></p>
            <div id="unit_list" class="wh_box mt20">
                <!--					<div class="grapharea">-->
                <!--						<h4>시각화 제목</h4>-->
                <!--						<div class="wrap_graph">-->
                <!--							<img src="/views/_layout/analysis/images/vis_img01_report.png"style="width: 100%; max-width: 860px;">-->
                <!--						</div>-->
                <!--					</div>-->
                <!--					<div class="grapharea">-->
                <!--						<h4>시각화 제목</h4>-->
