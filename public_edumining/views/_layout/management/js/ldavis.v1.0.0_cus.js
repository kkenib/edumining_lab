...
var LDAvis = function(to_select, data_or_file_name) {
    ...
    function visualize(data) {
        ...
        var mdsplot = svg.append("g")
                .attr("id", leftPanelID)
                .attr("class", "points")
                .attr("transform", "translate(" + (margin.left +30) + "," + 2 * margin.top + ")");
        ...
        var chart = svg.append("g")
                .attr("transform", "translate(" + +(mdswidth + margin.left + termwidth +30) + "," + 2 * margin.top + ")")
                .attr("id", barFreqsID);
        ...
        function init_forms(topicID, lambdaID, visID) {
            ...
            lambdaInput.setAttribute("style", "width: 250px; height: 25px; margin-left: 0px; margin-right: 0px");
