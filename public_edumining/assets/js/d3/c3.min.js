(function (window) {
    ...
    c3_chart_internal_fn.initWithData = function (data) {
        ...
        // 배경2
        main.insert('rect', config.zoom_privileged ? null : 'g.' + CLASS.regions)
        .attr('class', CLASS.zoomRectBackground)
        .attr('width', 0)
        .attr('height', $$.height)
        .style('opacity', 0.1)
        .on("dblclick.zoom", null);
      ...
      // Determin tooltip position
        if (forArc) {
            ...
            if (tooltipRight > chartRight) {
            	...
            	// tooltipLeft -= 220 + ($('.c3-tooltip-container').width() - 178);
            	
            	// 여러개 그래프의 툴팁이 존재하는 경우 정확환 class의 width를 찾아올수 없음 -> id 추가
            	tooltipLeft -= 220 + ($(config.bindto + '> div.c3-tooltip-container').width() - 178);
            	if (tooltipLeft < -20){
            		tooltipLeft = -10;
            	}
            }
    ...
    var CLASS = c3_chart_internal_fn.CLASS = {
        ...
        SELECTED: '_selected_',
        INCLUDED: '_included_',
        zoomRectBackground: 'c3-zoom-rect-background',
    };
