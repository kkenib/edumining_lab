...
| 설치시 환경변수 세팅
| Apache :  
|          SetEnv HOST_LANG "ko-KR"
|          SetEnvIf Host "^china" HOST_LANG="zh-CN"
| NGINX :  
|          fastcgi_param HOST_LANG "ko-KR";
*/

$_domain_prefix = array(
	  'textom' => ['']
);
$_domain_prefix_all = array_reduce($_domain_prefix, function($a, $b) { array_splice($a, count($a), 0, $b); return $a; }, []);
$_replace_domain = preg_replace('/^('.implode('|', $_domain_prefix_all).')[.]/i', '', $_SERVER['HTTP_HOST']);

$config['_domain_prefix'] = $_domain_prefix;
$config['_replace_domain'] = $_replace_domain;


$config['_region'] = array(
		'kr' => 'Korea',
		'cn' => 'China',
		'us' => 'America'
);
...
|
*/
$config['language'] = $config['_lang'][LANG];
 ...
 */
$config['encryption_key'] = 'xx00textomi00xx';
...
$config['cookie_domain'] = '.'.$_replace_domain;
$config['cookie_path'] = '/';
...
$config['csrf_exclude_uris'] = array(
        ...
        array('controller' => 'mobile_namechk', 'method' => 'mobile_self_proc'),
        array('controller' => 'inipayment', 'method' => 'inipay_result'),
);
