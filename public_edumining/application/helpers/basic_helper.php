...
if ( ! function_exists('script_reload') ) {
    
    function script_reload($msg = '', $target = '') {
        $msg_stat = (trim($msg) ? true : false);
        $msg = str_replace('"','\\"', $msg);
        if( trim($target) != '' ) $target = $target . '.';
        ...
        echo $target.'location.replace(location.href.replace(/#[^ ]*$/i, ""));';
        echo '</script>';
        exit;
    }
}

if ( ! function_exists('script_parent_reload') ) {
    
    function script_parent_reload($msg = '') {
        $msg_stat = (trim($msg) ? true : false);
        $msg = str_replace('"','\\"', $msg);
        ...
        echo 'parent.location.replace(parent.location.href.replace(/#[^ ]*$/i, ""));';
        echo '</script>';
        exit;
...
if ( ! function_exists('script_opener_reload') ) {
    
    function script_opener_reload($msg = '') {
        $msg_stat = (trim($msg) ? true : false);
        $msg = str_replace('"','\\"', $msg);
        ...
        echo 'opener.location.replace(opener.location.href.replace(/#[^ ]*$/i, ""));';
        echo '</script>';
        exit;
    }
}
...
if ( ! function_exists('script_redirect') ) {
    ...
    function script_redirect($url, $msg = '', $target = '') {
        $msg_stat = (trim($msg) ? true : false);
        $msg = str_replace('"','\\"', $msg);
		if(trim($target) != '') $target = $target . '.';
...
if ( ! function_exists('script_parent_redirect') ) {
    
    function script_parent_redirect($url, $msg = '') {
        $msg_stat = (trim($msg) ? true : false);
        $msg = str_replace('"','\\"', $msg);
...
if ( ! function_exists('script_opener_redirect') ) {

    function script_opener_redirect($url, $msg = '') {
        $msg_stat = (trim($msg) ? true : false);
        $msg = str_replace('"','\\"', $msg);
...
if ( ! function_exists('script_gopage') ) {
    
    function script_gopage($url, $msg = '', $target = '') {
        $msg_stat = (trim($msg) ? true : false);
		$msg = str_replace('"','\\"', $msg);
		if(trim($target) != '') $target = $target . '.';
...
if ( ! function_exists('script_parent_gopage') ) {

    function script_parent_gopage($url, $msg = '') {
        $msg_stat = (trim($msg) ? true : false);
		$msg = str_replace('"','\\"', $msg);
...
if ( ! function_exists('script_opener_gopage') ) {
    function script_opener_gopage($url, $msg = '') {
        $msg_stat = (trim($msg) ? true : false);
		$msg = str_replace('"','\\"', $msg);
...
if ( ! function_exists('script_open_window') ) {
    function script_open_window($url, $name='_blank', $msg = '') {
        $msg_stat = (trim($msg) ? true : false);
		$msg = str_replace('"','\\"', $msg);
...
if ( ! function_exists('script_close_window') ) {

    function script_close_window($msg='', $opener_url='') {
        $msg_stat = (trim($msg) ? true : false);
		$msg = str_replace('"','\\"', $msg);

        $opener_stat = (trim($opener_url) ? 'true' : 'false');
        ...
        if($opener_stat) {
            echo 'opener.location.href="'.$opener_url.'";';
        }
        echo 'window.close();';
        echo '</script>';
    }
