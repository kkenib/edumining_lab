 ...
 */
class Loginlog extends CB_Controller
{
     ...
     * 페이지 이동시 필요한 정보입니다
     */
    public $pagedir = 'member/loginlog';

    /**
     * 모델을 로딩합니다
     */
    protected $models = array('Member_login_log');

    /**
     * 이 컨트롤러의 메인 모델 이름입니다
     */
    protected $modelname = 'Member_login_log_model';
    ...
    {
        // 이벤트 라이브러리를 로딩합니다
        $eventname = 'event_admin_member_loginlog_index';
         ...
         */
        $search_option = array('mll_datetime' => '날짜', 'mll_ip' => 'IP', 'mll_reason' => '이유');
    ...
    {
        // 이벤트 라이브러리를 로딩합니다
        $eventname = 'event_admin_member_loginlog_listdelete';
        $this->load->event($eventname);
    ...
    {
        // 이벤트 라이브러리를 로딩합니다
        $eventname = 'event_admin_member_loginlog_cleanlog';
        $this->load->event($eventname);
