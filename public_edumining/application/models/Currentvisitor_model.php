...
class Currentvisitor_model extends CB_Model
{
    ...
    {
        $select = 'currentvisitor.*, member.mem_id, member.mem_userid, member.mem_nickname, member.mem_is_admin';
    ...
    {
        $this->db->select('currentvisitor.*, member.mem_id, member.mem_userid, member.mem_nickname, member.mem_is_admin');
